  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }} edges={["top"]}>
      <View style={{ flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 12 }}>
        ...
        <Text style={{ flex: 1, textAlign: "center", fontSize: 18, fontFamily: "Poppins_600SemiBold", color: colors.text }}>Followers</Text>
        <View style={{ width: 40 }} />
      </View>
      {isLoading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<View style={{ alignItems: "center", paddingVertical: 40 }}><Text style={{ color: colors.textSecondary, fontFamily: "Poppins_400Regular" }}>No followers yet</Text></View>}
        />
      )}
    </SafeAreaView>
  );
